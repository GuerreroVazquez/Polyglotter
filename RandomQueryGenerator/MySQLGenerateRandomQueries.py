...
class MySQLGenerateRandomQueries(GenerateRandomQueries):
...
if __name__ == "__main__":
    ...
    for training_set_size in training_set_sizes:
        ...
        trainingDataSaveDir = "../Data/TrainingData/MySQL/" + str(number_of_runs) + "/"
        
        generation_runs = MySQLGenerateRandomQueries.generateQuery(training_data_save_dir = trainingDataSaveDir,
